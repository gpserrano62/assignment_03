...
if uploaded_file and clicked:
    ...
    st.session_state.files_processed = st.session_state.files_processed + 1
    st.session_state.packages_processed = st.session_state.packages_processed + len(packages)
